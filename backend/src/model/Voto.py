...
class Voto(BaseEntity):
    ...
    def __init__(self, id: int, valor_lista: int, id_partido: int, id_eleccion: int, id_tipo_eleccion: int, es_observado: bool, id_tipo_voto: int, id_circuito: int, fecha: str):
        self.id = id
